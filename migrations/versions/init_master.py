...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('scheduled', 'queued', 'running', 'success', 'failed', 'canceled', name='celery_task_status', native_enum=False), server_default='queued', nullable=False),
    ...
    sa.Column('processing_status', sa.Enum('UNSPECIFIED', 'PROCESSING', 'READY', 'FAILED', name='video_processing_status', native_enum=False), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('type', sa.Enum('TYPE_UNSPECIFIED', 'PHOTO', 'VIDEO', name='media_item_type', native_enum=False), nullable=False),
    ...
    sa.Column('attr', sa.Enum('thing', 'person', 'place', 'event', 'scene', 'activity', 'source', 'others', name='tag_attr', native_enum=False), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), autoincrement=True, nullable=False),
    sa.Column('source_type', sa.Enum('local', 'google_photos', 'wiki-media', name='media_source_type', native_enum=False), nullable=False),
    ...
    sa.Column('visibility', sa.Enum('public', 'private', 'unlisted', name='album_visibility', native_enum=False), nullable=False),
    ...
    sa.Column('finished_at', sa.DateTime(), nullable=True),
    sa.Column('status', sa.Enum('queued', 'running', 'success', 'partial', 'failed', 'canceled', name='job_sync_status', native_enum=False), server_default='queued', nullable=False),
    ...
    sa.Column('level', sa.Enum('debug', 'info', 'warning', 'error', 'critical', name='audit_log_level', native_enum=False), nullable=False),
    sa.Column('category', sa.Enum('state_transition', 'file_operation', 'db_operation', 'validation', 'duplicate_check', 'error', 'performance', 'consistency', name='audit_log_category', native_enum=False), nullable=False),
    sa.Column('message', sa.Text(), nullable=False),
    sa.Column('session_id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=True),
    ...
    sa.Column('id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), autoincrement=True, nullable=False),
    sa.Column('media_id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=False),
    sa.Column('preset', sa.Enum('original', 'preview', 'mobile', 'std1080p', name='media_playback_preset', native_enum=False), nullable=False),
    ...
    sa.Column('hash_sha256', sa.CHAR(length=64), nullable=True),
    sa.Column('status', sa.Enum('pending', 'processing', 'done', 'error', name='media_playback_status', native_enum=False), nullable=False),
    ...
    sa.Column('id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), autoincrement=True, nullable=False),
    sa.Column('media_id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=False),
    sa.Column('type', sa.Enum('video', 'audio', 'subtitle', name='media_sidecar_type', native_enum=False), nullable=False),
    sa.Column('rel_path', sa.String(length=255), nullable=True),
    sa.Column('bytes', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=True),
    sa.ForeignKeyConstraint(['media_id'], ['media.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('status', sa.Enum('pending', 'enqueued', 'running', 'imported', 'dup', 'failed', 'expired', 'skipped', name='picker_selection_status', native_enum=False), server_default='pending', nullable=False),
