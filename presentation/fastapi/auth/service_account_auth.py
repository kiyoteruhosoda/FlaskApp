...
from presentation.fastapi.services.service_account_service import ServiceAccountService
...
def _verify_service_account_jwt(token: str, *, required_scopes=None, audience=None):
    """Verify a service account JWT and return the account, or None on failure."""
    try:
