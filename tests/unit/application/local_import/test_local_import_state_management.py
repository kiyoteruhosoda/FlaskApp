...
class TestLoggingIntegration:
    ...
    def test_log_with_audit_graceful_degradation(self):
        """監査ログが未初期化でも失敗しないこと"""
        from bounded_contexts.photonest.infrastructure.local_import.logging_integration import log_with_audit
    ...
    def test_log_file_operation(self):
        """ファイル操作ログのテスト"""
        from bounded_contexts.photonest.infrastructure.local_import.logging_integration import log_file_operation
...
class TestIntegrationExample:
    ...
    def test_process_file_phase2_signature(self):
        """Phase2関数のシグネチャ確認"""
        from bounded_contexts.photonest.application.local_import.integration_example import (
            process_file_phase2,
        )
