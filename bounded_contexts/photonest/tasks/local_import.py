...
def enqueue_thumbs_generate(*args, **kwargs):
    """Proxy to :func:`bounded_contexts.photonest.tasks.media_post_processing.enqueue_thumbs_generate`."""

    return media_post_processing.enqueue_thumbs_generate(*args, **kwargs)


def enqueue_media_playback(*args, **kwargs):
    """Proxy to :func:`bounded_contexts.photonest.tasks.media_post_processing.enqueue_media_playback`."""
...
def _invoke_current_import_single_file(
    ...
    *,
    ...
    from bounded_contexts.photonest.tasks import local_import as local_import_module
